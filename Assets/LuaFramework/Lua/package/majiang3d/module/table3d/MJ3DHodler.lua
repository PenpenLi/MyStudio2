...
function Mj3dHodler:Create(tableSeat,parent)
    ...
    if 2 == hodler.tableSeat.view.totalSeat then
        ...
        hodler.thorwMjRowMaxCount = 5
    end

    ---处理不同方位花牌的排列间隔
    hodler.huaMaxRowCount = 4
    hodler.huaXSpaceing = -2.82
    hodler.huaZSpaceing = 3.65
    if 1 == hodler.tableSeat.seatId or 3 == hodler.tableSeat.seatId then
        hodler.huaXSpaceing = -2.67
    elseif 2 == hodler.tableSeat.seatId then
        hodler.huaXSpaceing = -2.77
    elseif 4 == hodler.tableSeat.seatId then
        hodler.huaXSpaceing = -2.72
    end
