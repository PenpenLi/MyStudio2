...
namespace ABEditor
{
    ...
    {
        public static bool IsUseJunYu = true;
        ...
        //君语
        static string accessKeyId = "LTAIoh83xRL7LLxO";
        static string accessKeySecret = "rFVj69xqW7PyUggHbebCv73YErYHvK";
        static string host = "appkgs.oss-cn-huhehaote.aliyuncs.com";
