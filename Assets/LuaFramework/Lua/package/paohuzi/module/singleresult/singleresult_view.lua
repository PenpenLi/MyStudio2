...
function SingleResultView:initialize(...)
	...
	self.FanXingDongHuaRImgGOTable = {}

	for i=1,9 do
		self.FanXingDongHuaRImgGOTable[i] = Manager.FindObject(self.root, "FanXingDongHuaR/Pai" ..i)
	end

	self.FanXingDongMen = {}
	self.FanXingDongMenGo = Manager.FindObject(self.root, "FanXingDongMen")
	for i=1,9 do
		self.FanXingDongMen[i] = Manager.FindObject(self.root, "FanXingDongMen/Pai" ..i)
	end
