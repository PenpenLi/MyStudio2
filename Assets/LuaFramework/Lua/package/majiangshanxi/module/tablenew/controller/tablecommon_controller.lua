    ...
    self.module:subscibe_time_event(waitTime, false, 0):OnComplete(function(t)
        if(self.module:can_show_result()) then
            ...
            if self.view.ConfigData.pnShowResult then
                onegameresultModule = ModuleCache.ModuleManager.show_module("majiangshanxi", "onegameresultpuning", gameState)
            else
                onegameresultModule = ModuleCache.ModuleManager.show_module("majiangshanxi", "onegameresult", gameState)
            end
