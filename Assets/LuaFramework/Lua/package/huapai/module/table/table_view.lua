...
function TableView:initialize(...)
    ...
    self.QiZhangObj = Manager.FindObject(self.root, "Players/QiZhang")
    ...
    self.Top_Image = Manager.FindObject(self.root, "Top/Image") 

    if TableManager.phzTableData.isPlayBack then
        self.Top_Image:SetActive(false)
    end
    ...
    if self.LeftRoot1 then
        ...
        self.BtnLeftOpen.onClick:AddListener(
            function()
                ...
                if DataHuaPai.Msg_Table_GameStateNTF == nil then
                    self.btnLeaveText1.text = "退出"
                else
                    self.btnLeaveText1.text = "解散"
                end
        ...
        self.btnLeaveText1 = Manager.GetText(self.JinBiChangMatch, "ButtonJinBiChangExit/Text")
        self.ButtonRuleExplain1 = Manager.GetButton(self.JinBiChangMatch, "ButtonRuleExplain")
        self.ButtonGPS1 = Manager.GetButton(self.JinBiChangMatch, "ButtonGPS")
